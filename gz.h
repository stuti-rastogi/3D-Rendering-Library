...
#define GZ_REND_NO				888	/*to check which number of renderer it is*/
...
//flavors for shared edge resolution in put triangle
#define TOP 51
#define BOTTOM 52
#define LEFT 53
#define RIGHT 54
...
/**************************** NEW ADDITION HW6 *************************************************/
#define	AAKERNEL_SIZE	6			//number of super samples
